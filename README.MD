...
- Se rendre a la racine du projet Symfony dans le fichier `.env` et décommenter la ligne:
```js
...
- __Executer la commande suivante dans un terminal :__ `symfony console make:user`.
